...
arnn_ts <- as.ts(potencias_data_ts$POTENCIA_TRAFO)
...
# Prediccion 
out_of_sample_arnn_prediction <- forecast(arnn_fit, h=medidas_predecir, level=90)
...
plot(forecast(arnn_fit, h=medidas_predecir, level=90),main="Pontencias trafico")
